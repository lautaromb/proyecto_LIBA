    ...
    <div class="row">
        ...
        <form action="formulario_destino.php" method="POST">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nombre" name="usuario" placeholder="Escriba su usuario">
            </div>
            <div class="mb-3">
                <label for="apellido" class="form-label">Contraseña</label>
                <input type="password" class="form-control" id="apellido" name="pass" placeholder="Escriba su contraseña">
            </div>
