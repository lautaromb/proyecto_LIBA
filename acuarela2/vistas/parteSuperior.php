    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">Libreria Acuarela</div>
            </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!--<li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <!--<div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="alertsDropdown">-->   <!--CIERRA ACA
                           ...
                           aLERTAS -->   
                        <!-- Nav Item - Messages mENSAJES DE LA CASIILA DE COOREO -->
                        <li class="nav-item dropdown no-arrow mx-1">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Admin Acuarela</span>
